...
//
//            System.out.println("Zum einfachen Nachgucken: Spaltennamen, der enthaltene Dateityp und ihre Größe");
//            ResultSetMetaData metaData = resultSet.getMetaData();
//            for (int col = 1; col <= metaData.getColumnCount(); col++) {
//                System.out.println(metaData.getColumnLabel(col) + ", Type: " +
//                        metaData.getColumnTypeName(col) + ", Size: " +
