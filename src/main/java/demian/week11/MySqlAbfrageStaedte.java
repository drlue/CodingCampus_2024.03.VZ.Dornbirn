    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 3. mit dem Namen eine SQL Abfrage ausführt
                ...
                PreparedStatement ps = conn.prepareStatement("select city.Name as Stadt, city.Province, city.population as Bundesland, Country.Name as Staat from city join country on city.Country = Country.Code where Country.Name like ?");
...
//            System.out.println("----------------------------------------------------");
    ...
    public static void printResultSet(ResultSet rs) throws SQLException {
        ...
        // Print separator
        for (int i = 1; i <= columnCount; i++) {
            System.out.print("".format("%20s", "").replace(' ', '-'));
        }
        System.out.println();
