...
public class AufgabeNumberArray {
    ...
    public static void main(String[] args) {
        ...
        int userinput = ScannerUebung.getINT("Geben Sie bitte die gewünschte Größe des Arrays an ==>", 0, 888);
        ...
        userinput = ScannerUebung.getINT("Geben Sie bitte die gewünschte Größe des Arrays an ==>", 0, 888);
