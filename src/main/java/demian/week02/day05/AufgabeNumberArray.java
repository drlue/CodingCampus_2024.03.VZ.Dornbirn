...
public class AufgabeNumberArray {
    ...
    public static void main(String[] args) {
        ...
        int userinput = ScannerNachbau.consoleINTEGERinput("Geben Sie bitte die gewünschte Größe des Arrays an ==>", 0, 888);
        ...
        userinput = ScannerNachbau.consoleINTEGERinput("Geben Sie bitte die gewünschte Größe des Arrays an ==>", 0, 888);
